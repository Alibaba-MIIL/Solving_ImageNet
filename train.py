...
from timm.utils.kd.kd_utils import build_kd_model
...
parser.add_argument('--crop-pct', default=0.95, type=float,
...
parser.add_argument('--weight-decay', type=float, default=2e-2,
                    help='weight decay (default: 2e-2)')
...
parser.add_argument('--aug-repeats', type=int, default=3,
...
parser.add_argument('--model-ema', type=int, default=1,
